...
<html>
    ...
    <body>
        ...
        <div id="solutionDiv">
            <div id="mutlipleDiv" class="form-group">
                <label for="solution" class="col-lg-2 control-label">Mogelijkheden (*)</label>
                <div id = "multipleChoice" class="col-lg-10 multipleChoice">
                    <p style="background-color:#93c54b" type="text" class="enriched form-control" name="solution" id="solution" title="De oplossing op de vraag"></p>
                </div>
                <a class="col-lg-2 control-label" onclick="generateAnotherAnswer()" style="cursor:pointer; text-decoration: underline">Voeg een mogelijkheid toe</a>
                <a class="col-lg-2 control-label" id="deleteLast" onclick="removeLastAnswer()" style="cursor:pointer; text-decoration: underline; visibility: hidden;">Verwijder de laatste mogelijkheid</a>
