...
<html>
    ...
    <body>
        ...
        <div id="reactionDiv" class="form-group">
            <label for="solution" class="col-lg-2 control-label">Oplossing (*)</label><br>
            <select id="selectArrow" autocomplete="off" onchange= "generateArrowForSolution(this.value)" class="form-control" name="solution" style="margin-left:15px;width:200px">
                <option id="default" name="aflopend" value="0">Aflopende reactie</option>
                <option name="evenwicht" value="1">Evenwichtsreactie</option>
            </select> 
            <div id = "reactionSolution" class="col-lg-10 reaction">
        ...
        <a class="" onclick="generateLeft()" style="cursor:pointer; text-decoration: underline">Voeg links een element toe</a>
        <br><a class="" onclick="generateRight()" style="cursor:pointer; text-decoration: underline">Voeg rechts een element toe</a>
        <p id="errorMessage2" style="color:#c9302c;"></p>
        <div class="form-group">
